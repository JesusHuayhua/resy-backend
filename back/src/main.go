...
func main() {
	...
	dbManager.Close()
	/*palabracodificada,_ :=crypto.Encrypt("Katarin13")
	fmt.Println(palabracodificada)
	palabradecodificada,_ :=crypto.Decrypt(palabracodificada)
	fmt.Println(palabradecodificada)*/
}
